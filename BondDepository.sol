...
contract DomeBondDepository is Ownable {
    ...
    function maxPayout() public view returns ( uint ) {
        return IERC20( DOME ).totalSupply().mul( terms.maxPayout ).div( 100000 );
    }
    ...
    /**
     *  @notice calculate current ratio of debt to DOME supply
     *  @return debtRatio_ uint
     */
    function debtRatio() public view returns ( uint debtRatio_ ) {   
        uint supply = IERC20( DOME ).totalSupply();
    ...
    /**
     *  @notice calculate amount of DOME available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or DOME) to the DAO
     *  @return bool
     */
