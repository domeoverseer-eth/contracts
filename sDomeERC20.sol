...
contract sDome is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Dome", "sDOME", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDOME supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDOME
